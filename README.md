...
- `demo_app.asset`: Provides asset mapping. Maps broker's asset IDs to Eliona asset IDs.
...
Assets for all devices connected to the Demo account are created automatically when the configuration is added.
