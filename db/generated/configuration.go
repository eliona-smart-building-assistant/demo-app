...
type Configuration struct {
	...
	SiteID          null.String `boil:"site_id" json:"site_id,omitempty" toml:"site_id" yaml:"site_id,omitempty"`
...
var ConfigurationWhere = struct {
	...
	ID:              whereHelperint64{field: "\"demo_app\".\"configuration\".\"id\""},
	TenantID:        whereHelperstring{field: "\"demo_app\".\"configuration\".\"tenant_id\""},
	SiteID:          whereHelpernull_String{field: "\"demo_app\".\"configuration\".\"site_id\""},
	RefreshInterval: whereHelperint32{field: "\"demo_app\".\"configuration\".\"refresh_interval\""},
	RequestTimeout:  whereHelperint32{field: "\"demo_app\".\"configuration\".\"request_timeout\""},
	AssetFilter:     whereHelpertypes_JSON{field: "\"demo_app\".\"configuration\".\"asset_filter\""},
	Active:          whereHelperbool{field: "\"demo_app\".\"configuration\".\"active\""},
	Enable:          whereHelperbool{field: "\"demo_app\".\"configuration\".\"enable\""},
	UserID:          whereHelperstring{field: "\"demo_app\".\"configuration\".\"user_id\""},
}
...
func (o *Configuration) GetAssets() AssetSlice {
	if o == nil {
		return nil
	}
...
var (
	configurationAllColumns            = []string{"id", "tenant_id", "site_id", "refresh_interval", "request_timeout", "asset_filter", "active", "enable", "user_id"}
	configurationColumnsWithoutDefault = []string{"tenant_id", "asset_filter", "user_id"}
	configurationColumnsWithDefault    = []string{"id", "site_id", "refresh_interval", "request_timeout", "active", "enable"}
...
func (o *Configuration) Assets(mods ...qm.QueryMod) assetQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"demo_app\".\"asset\".\"configuration_id\"=?", o.ID),
	)
...
func (configurationL) LoadAssets(ctx context.Context, e boil.ContextExecutor, singular bool, maybeConfiguration any, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`demo_app.asset`),
		qm.WhereIn(`demo_app.asset.configuration_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	for _, rel := range related {
		if insert {
			...
			updateQuery := fmt.Sprintf(
				"UPDATE \"demo_app\".\"asset\" SET %s WHERE %s",
...
func Configurations(mods ...qm.QueryMod) configurationQuery {
	mods = append(mods, qm.From("\"demo_app\".\"configuration\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"demo_app\".\"configuration\".*"})
	}
...
func FindConfiguration(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Configuration, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"demo_app\".\"configuration\" where \"id\"=$1", sel,
	)
...
func (o *Configuration) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"demo_app\".\"configuration\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"demo_app\".\"configuration\" %sDEFAULT VALUES%s"
		}
...
func (o *Configuration) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"demo_app\".\"configuration\" SET %s WHERE %s",
...
func (o ConfigurationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"demo_app\".\"configuration\" SET %s WHERE %s",
...
func (o *Configuration) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"demo_app\".\"configuration\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func (o *Configuration) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"demo_app\".\"configuration\" WHERE \"id\"=$1"
...
func (o ConfigurationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"demo_app\".\"configuration\" WHERE " +
...
func (o *ConfigurationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"demo_app\".\"configuration\".* FROM \"demo_app\".\"configuration\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, configurationPrimaryKeyColumns, len(*o))
...
func ConfigurationExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"demo_app\".\"configuration\" where \"id\"=$1 limit 1)"
